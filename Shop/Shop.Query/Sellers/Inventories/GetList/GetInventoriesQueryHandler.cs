...
public class GetInventoriesQueryHandler : IQueryHandler<GetInventoriesListQuery, List<InventoryDto>>
{
    ...
    public async Task<List<InventoryDto>> Handle(GetInventoriesListQuery request, CancellationToken cancellationToken)
    {
